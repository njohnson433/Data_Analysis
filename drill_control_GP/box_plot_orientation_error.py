...
sp_data = data[['ID','OE1 [Â°]','OE2 [Â°]','OE3 [Â°]']]

# filter the data with the desired strategy
sp_data_filtered = drop_NA(sp_data)

# get series per bone type for robotic assistance
robot_generic = sp_data_filtered['OE1 [Â°]']
robot_femur   = sp_data_filtered['OE2 [Â°]']
robot_ulna   = sp_data_filtered['OE3 [Â°]']
...
ax.set_title("Orientation Error Bone Type Comparison")
